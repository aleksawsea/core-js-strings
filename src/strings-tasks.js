...
function removeFirstOccurrences(str, value) {
  ...
  if (firstIndex >= 0) {
    ...
    const secondPart = str.slice(lastIndex);
...
function unbracketTag(str) {
  const newStr = str.replace(String.fromCharCode(60), '');
  return newStr.replace(String.fromCharCode(62), '');
}
